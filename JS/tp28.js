...
formInscription.addEventListener("submit", function (e) {
  ...
  if (
    ...
    deleteButton.addEventListener("click", function () {
      const trParent = deleteButton.parentElement;
      trParent.parentElement.removeChild(trParent);
    });

    //On append
    tableauEtudiants.append(tr);
    tr.append(nom, prenom, age, genre, pays, option, listeCours, deleteButton);
